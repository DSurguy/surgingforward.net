...
repositoryUrl: 'https://github.com/DSurguy/bingo-builder'
---

## Links
- [https://bingo.surgingforward.net](https://bingo.surgingforward.net)
- [https://github.com/DSurguy/bingo-builder](https://github.com/DSurguy/bingo-builder)
...
I wanted to give every person a bingo sheet that contained silly social activities, and reward prizes when they acheived bingo or blackout on their sheet. To make it easy to hang onto their sheet, I wanted to be able to stick the sheets onto cups that people could carry around and fill with party drinks.
...
![screenshot of project list](/bingo-builder/project.png "Project List")
...
![screenshot of bingo lines in form](/bingo-builder/lines.png "Bingo Lines")

![screenshot of bingo settings](/bingo-builder/settings.png "Bingo Settings")
...
![screenshot of bingo generation and output](/bingo-builder/output.png "Bingo Generation")
